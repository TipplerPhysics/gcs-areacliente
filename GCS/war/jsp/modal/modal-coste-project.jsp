				...
				<div class="form-container">
					<div class="form-field-divider left">
						...
						<div class="form-field">
							...
							<div class="input">
								<input type="text" value="${coste.str_fecha_alta}" size="16" class="datepicker" data-target-id='fecha_alta_costes_modal' name="fecha_alta_costes" id="fecha_alta_costes_modal" required aria-required="true">
							</div>
						</div>
						<div class="form-field">
						...
						<div class="form-field">
							...
							<div class="input">
								<input type="text" value="${coste.str_fecha_solicitud_valoracion}" size="16" class="datepicker" data-target-id='fecha_solicitud_valoracion_modal' name="fecha_solicitud_valoracion" id="fecha_solicitud_valoracion_modal" required aria-required="true">
							</div>
						</div>
					...
					<div class="form-field-down">
						...
						<span class="lbl"></span>
							<div class="input total">
								<input id="total_horas_modal" name="total_horas" class="horas" value="${coste.horas_total}"/>
